...
//   ׳׳…׳׳ U+05F3 כפול - גרש עברי בודד שהוקלד פעמיים
//
// הגרש הכפול ׳׳ נתמך כי הוא נראה כמעט זהה לגרשיים ומוקלד בטעות במקומם,
// והוא חד-משמעי: בעברית הגרש הבודד משמש לקיצורים (ר׳ עקיבא, ג׳ירפה) אך
// לעולם אינו מופיע כפול.
//
// לעומתו הגרשיים העבריים ״ (U+05F4) אינם נתמכים בכוונה: אותו תו משמש
// לראשי תיבות (תנ״ך, ד״ר, צה״ל), ובמשפט כמו "ד״ר וגם תנ״ך" שני הסימנים
// היו מזדווגים לציטוט שמתחיל באמצע מילה ומסתיים באמצע מילה אחרת.
